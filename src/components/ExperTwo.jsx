...
function ExperTwo() {
  return (
    <div className="w-full h-full flex items-center justify-around lg:flex-row sm:flex-col">
          ...
          <div className="mt-10">
            {Expernise.map((date)=>{
                return  <>
                 ...
                 className="mt-10 sm:text-base text-xl bg-gradient-to-r from-violet-500 via-fuchsia-400 to-fuchsia-500  text-transparent bg-clip-text tracking-tight">{date.role} - {date.company}
                 </motion.h1>
                 <motion.h6
                  whileInView={{x:0,opacity:1}}
                  initial={{x:100,opacity:0}}
                  transition={{duration:0.5}}
                  className="mt-5 pr-5 sm:pr-0 lg:pr-0 text-sm">{date.description}
                  </motion.h6>
                 <motion.div
                  whileInView={{x:0,opacity:1}}
                  initial={{x:100,opacity:0}}
                  transition={{duration:0.5}}
                  className="w-1/2 flex sm:pb-6 gap-4 mt-2">
